<%@ Page Title="" Language="C#" MasterPageFile="~/MFYF.Master" AutoEventWireup="true" CodeBehind="M_DeviceMaster.aspx.cs" Inherits="FeelYourFood.M_DeviceMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wrapper">
        <div class="row">
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div class="user-details">
                        ...
                        <div class="title">Device Master </div>
                        <div class="user-form">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <asp:TextBox ID="device" runat="server" placeholder="Enter Device Name" required="" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
            ...
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div style="font-weight: bold">Device List</div>
                    <hr style="margin-top: 10px;" />
                    <div class="bg-wrapper table-responsive">
                        <asp:GridView ID="gvdevice" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            EmptyDataText="No Device Found." DataKeyNames="Id" CssClass="table table-bordered table-striped table-responsive-md"
                            HeaderStyle-CssClass="thead-dark" OnPageIndexChanging="gvdevice_PageIndexChanging">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="/images/del.png" Width="30" Height="30"
                                            CommandArgument='<%#Eval("Id")%>' OnClientClick="return confirm('Are you sure you want to delete this device ?');"
