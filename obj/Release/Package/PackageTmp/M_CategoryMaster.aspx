<%@ Page Title="" Language="C#" MasterPageFile="~/MFYF.Master" AutoEventWireup="true" CodeBehind="M_CategoryMaster.aspx.cs" Inherits="FeelYourFood.M_CategoryMaster" %>
 ...
 <!--body wrapper start-->
    <div class="wrapper">
        <div class="row">
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div class="user-details">
                        ...
                        <div class="title">Food Category Master </div>
                        <div class="user-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <asp:TextBox ID="CategoryName" runat="server" placeholder="Category Name" required="" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
            ...
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div style="font-weight: bold">Food Category List</div>
                    <hr style="margin-top: 10px;" />
                    <div class="bg-wrapper table-responsive">
                        <asp:GridView ID="gvcred" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            EmptyDataText="No Food Category Found." DataKeyNames="TypeId" OnPageIndexChanging="gvrestdetail_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CategoryName" HeaderText="Food Category" SortExpression="type" />
                                ...
                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageBtnEdit" runat="server" ImageUrl="/images/edit.png" Width="30" Height="30"
                                            CommandArgument='<%#Eval("TypeId")%>' OnCommand="ImageBtnEdit_Command" formnovalidate="formnovalidate" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageBtnDelete" runat="server" ImageUrl="/images/del.png" Width="30" Height="30"
                                            CommandArgument='<%#Eval("TypeId")%>' OnClientClick="return confirm('Are you sure you want to delete this food category?');"
