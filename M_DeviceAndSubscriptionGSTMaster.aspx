<%@ Page Title="" Language="C#" MasterPageFile="~/MFYF.Master" AutoEventWireup="true" CodeBehind="M_DeviceAndSubscriptionGSTMaster.aspx.cs" Inherits="FeelYourFood.M_DeviceAndSubscriptionGSTMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wrapper">
        <div class="row">
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div class="user-details">
                        ...
                        <div class="title">Device and Software GST Master </div>
                        <div class="user-form">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Device GST</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <asp:TextBox ID="devicegst" runat="server" placeholder=" Enter Device GST" type="number" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Software GST</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <asp:TextBox ID="softwaregst" runat="server" placeholder=" Enter Subscription GST" type="number" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
            ...
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div style="font-weight: bold">Device GST List</div>
                    <hr style="margin-top: 10px;" />
                    <div class="bg-wrapper table-responsive">
                        <asp:GridView ID="gvgst" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            EmptyDataText="No Device and Software GST Found." DataKeyNames="Id" CssClass="table table-bordered table-striped table-responsive-md"
                            HeaderStyle-CssClass="thead-dark" OnPageIndexChanging="gvgst_PageIndexChanging">
                            <Columns>
                                ...
                                <asp:BoundField DataField="devicegst" HeaderText="Device GST" />
                                <asp:BoundField DataField="softwaregst" HeaderText="Software GST" />
