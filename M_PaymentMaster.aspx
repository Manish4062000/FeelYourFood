<%@ Page Title="" Language="C#" MasterPageFile="~/MFYF.Master" AutoEventWireup="true" CodeBehind="M_PaymentMaster.aspx.cs" Inherits="FeelYourFood.M_PaymentMaster" %>
...
<div class="wrapper">
    <div class="row">
        <div class="col-md-12">
            <div class="rest-details-sub">
                <div class="user-details">
                    ...
                    <div class="title">Payment Master </div>
                    <div class="user-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <asp:TextBox ID="paymentName" runat="server" placeholder="Payment Mode" required="" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
        ...
        <div class="col-md-12">
            <div class="rest-details-sub">
                <div style="font-weight: bold">Mode of Payment List</div>
                <hr style="margin-top: 10px;" />
                <div class="bg-wrapper table-responsive">
                    <asp:GridView ID="gvpayment" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        EmptyDataText="No Payment Mode Found." DataKeyNames="PaymentModeId" OnPageIndexChanging="gvrestdetail_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PaymentMode" HeaderText="Payment Mode" SortExpression="type" />
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageBtnEdit" runat="server" ImageUrl="/images/edit.png" Width="30" Height="30"
                                        CommandArgument='<%#Eval("PaymentModeId")%>' OnCommand="ImageBtnEdit_Command" formnovalidate="formnovalidate" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Delete">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageBtnDelete" runat="server" ImageUrl="/images/del.png" Width="30" Height="30"
                                        CommandArgument='<%#Eval("PaymentModeId")%>' OnClientClick="return confirm('Are you sure you want to delete this Payment Mode?');"
