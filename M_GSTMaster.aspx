<%@ Page Title="" Language="C#" MasterPageFile="~/MFYF.Master" AutoEventWireup="true" CodeBehind="M_GSTMaster.aspx.cs" Inherits="FeelYourFood.M_GSTMaster" %>
...
<div class="wrapper">
        <div class="row">
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div class="user-details">
                        ...
                        <div class="title">GST Master </div>
                        <div class="user-form">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <asp:TextBox ID="cgst" runat="server" placeholder="Enter CGST Percentage" required="" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <asp:TextBox ID="sgst" runat="server" placeholder=" Enter SGST Percentage" required="" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <asp:TextBox ID="gst" runat="server" placeholder=" Enter GST Percentage" required="" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
            ...
            <div class="col-md-12">
                <div class="rest-details-sub">
                    <div style="font-weight: bold">GST List</div>
                    <hr style="margin-top: 10px;" />
                    <div class="bg-wrapper table-responsive">
                        <asp:GridView ID="gvgst" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            EmptyDataText="No Gst Found." DataKeyNames="Id" CssClass="table table-bordered table-striped table-responsive-md"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CGST_PERCENTAGE" HeaderText=" CGST PERCENTAGE" />
                                <asp:BoundField DataField="SGST_PERCENTAGE" HeaderText="SGST PERCENTAGE" />
                                <asp:BoundField DataField="GST_PERCENTAGE" HeaderText="GST PERCENTAGE" />
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="/images/del.png" Width="30" Height="30"
                                            CommandArgument='<%#Eval("Id")%>' OnClientClick="return confirm('Are you sure you want to delete this GST ?');"
